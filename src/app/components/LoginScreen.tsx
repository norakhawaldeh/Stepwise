    ...
    <div className="min-h-screen" style={{ backgroundColor: '#FAFAF7' }}>
      <div className="max-w-[390px] mx-auto min-h-[844px] px-6 py-12">
        ...
        >
          ...
          <p className="text-[15px]" style={{ color: '#9B96C8' }}>
            Welcome back.
          </p>
        </div>
        ...
        <div className="bg-white rounded-[20px] p-6 mb-6 shadow-lg">
          {/* Email */}
          <div className="mb-4">
            <label className="block text-[13px] font-medium mb-2" style={{ color: '#1A1F36' }}>
              Email
            </label>
            <input
              type="email"
          ...
          <div className="text-right mb-6">
            <button className="text-[13px]" style={{ color: '#FF6B4A' }}>
              Forgot password?
            </button>
          </div>
          ...
          {/* Google Button */}
          <button className="w-full py-3.5 rounded-[14px] border flex items-center justify-center gap-3 hover:bg-gray-50 transition-colors" style={{ borderColor: '#D0D0D0' }}>
        ...
        <div className="text-center">
          ...
          <button onClick={onSignUp} className="text-[14px] font-bold" style={{ color: '#FF6B4A' }}>
            Sign up
          </button>
        </div>
      </div>
