...
export function DarkEstimateTimeScreen({
  onBack,
  onGeneratePlan,
  onNavigate,
}: DarkEstimateTimeScreenProps) {
    ...
    const estimateTime = async () => {
      try {
        ...
        localStorage.setItem(
          ...
          JSON.stringify({
            ...draft,
            aiEstimatedMinutes: totalMinutes,
            estimatedReason: estimate.shortReason,
          })
        )
      } catch (error) {
        console.error(error)
        setHours(1)
        setMinutes(30)
        setReason('We made a safe estimate, but feel free to adjust it.')
      } finally {
        setProgress(100)
  ...
  const handleGenerate = () => {
    ...
    localStorage.setItem(
      ...
      JSON.stringify({
        ...draft,
        confirmedEstimatedMinutes: Math.max(15, totalMinutes),
      })
    )
  ...
  const adjustMinutes = (change: number) => {
    let newTotal = totalMinutes + change
    newTotal = Math.max(15, newTotal)
      ...
      <div className="min-h-screen relative overflow-hidden" style={{ backgroundColor: '#0D0F14' }}>
        <div className="max-w-[430px] mx-auto h-screen flex flex-col relative px-5 pt-8 pb-28">
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center">
            ...
            <h1 className="text-[25px] font-bold mb-3" style={{ color: '#F0F2F5' }}>
              Analyzing your assignment...
            </h1>

            <p className="text-[15px] leading-relaxed mb-8 max-w-[300px]" style={{ color: '#A0A5B0' }}>
              Stepwise is estimating how much time this will take.
            </p>
    ...
    <div className="min-h-screen relative overflow-hidden" style={{ backgroundColor: '#0D0F14' }}>
      <div className="max-w-[430px] mx-auto h-screen flex flex-col relative">
        <div className="flex-1 overflow-y-auto px-5 pt-8 pb-36">
          <button onClick={onBack} className="mb-7">
            <ArrowLeft size={22} color="var(--accent-color)" />
          </button>
          ...
          <div className="mb-7 text-center">
            ...
            <div className="mb-10 text-center">
                <p
                    ...
                    style={{ color: '#A0A5B0' }}
                >
                    We estimated how long this assignment may take.
                </p>
          ...
          >
            ...
            <p className="text-[14px] font-bold uppercase tracking-[0.14em] mb-2" style={{ color: 'var(--accent-color)' }}>
              Estimated Time
            </p>

            <h2 className="text-[34px] font-bold mb-2" style={{ color: '#F0F2F5' }}>
              {hours}h {minutes}m
            </h2>
          ...
          <div
            ...
            style={{ backgroundColor: '#161920', border: '1px solid #242830' }}
          >
            <h2 className="text-[16px] font-bold mb-2" style={{ color: '#F0F2F5' }}>
              Adjust if needed
            </h2>

            <p className="text-[12px] mb-5" style={{ color: '#8B909A' }}>
              Be honest! This helps Stepwise create a realistic plan.
            </p>

            <div className="grid grid-cols-2 gap-4">
              <div>
                <p className="text-[13px] mb-2" style={{ color: '#A0A5B0' }}>
                  Hours
                </p>

                <div className="flex items-center justify-between rounded-[16px] px-3 py-3" style={{ backgroundColor: '#0D0F14', border: '1px solid #242830' }}>
                  <button onClick={() => setHours(Math.max(0, hours - 1))}>
                    <Minus size={18} color="var(--accent-color)" />
                  </button>
              ...
              <div>
                ...
                <div className="flex items-center justify-between rounded-[16px] px-3 py-3" style={{ backgroundColor: '#0D0F14', border: '1px solid #242830' }}>
                  <button onClick={() => adjustMinutes(-15)}>
                    <Minus size={18} color="var(--accent-color)" />
                  </button>
