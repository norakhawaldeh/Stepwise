...
export function ScheduleScreen({ onNavigate }: ScheduleScreenProps) {
  const days = [
    { abbr: 'Mon', date: 6, isToday: false, isSelected: false },
    { abbr: 'Tue', date: 7, isToday: false, isSelected: false },
    { abbr: 'Wed', date: 8, isToday: false, isSelected: false },
    { abbr: 'Thu', date: 9, isToday: false, isSelected: false },
    { abbr: 'Fri', date: 10, isToday: true, isSelected: true },
    { abbr: 'Sat', date: 11, isToday: false, isSelected: false },
    { abbr: 'Sun', date: 12, isToday: false, isSelected: false },
  ];
  ...
  const schedule = [
    ...
    {
      time: '11:00 AM',
      task: 'Math Problem Set · Complete questions 1–10',
    ...
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: '#EAF4FB' }}>
        ...
        <div className="px-6 mb-4">
            ...
            {days.map((day, idx) => (
              ...
              >
                ...
                <div
                  ...
                  style={{
                    backgroundColor: day.isToday ? '#3A8DC7' : 'transparent',
          ...
          <div className="flex gap-2">
            <button
              ...
              style={{ backgroundColor: '#3A8DC7', color: 'white' }}
            >
              All Tasks
            </button>
            <button
              ...
              <div key={idx} className="flex gap-4">
                ...
                <div className="flex-1">
                  {item.task ? (
                    ...
                    >
                      <h4 className="text-[14px] font-bold mb-1" style={{ color: '#333' }}>
                        {item.task}
                      </h4>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t flex items-center justify-around h-16 max-w-[390px] mx-auto w-full" style={{ borderColor: '#E0E0E0' }}>
        ...
        <button
          ...
          className="flex flex-col items-center gap-1 flex-1 py-2"
        >
          <Calendar size={20} color="#3A8DC7" />
          <span className="text-[11px] font-medium" style={{ color: '#3A8DC7' }}>Schedule</span>
        </button>
        <button
